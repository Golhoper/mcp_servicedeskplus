...
"""
Test script to check connection to ServiceDesk Plus and CMDB features
"""
...
async def test_cmdb_features():
    ...
    try:
        async with ServiceDeskPlusClient() as client:
            ...
            print("    - Fetching asset categories...")
            ...
            print("    - Fetching software licenses...")
            ...
            print("    - Fetching software products...")
...
async def test_advanced_features():
    ...
    try:
        async with ServiceDeskPlusClient() as client:
            ...
            # Test pagination
            print("  📄 Pagination:")
            print("    - Test pagination with limit=10...")
...
async def test_admin_features():
    ...
    try:
        async with ServiceDeskPlusClient() as client:
            ...
            print("    - Fetching admin technicians...")
            ...
            print("    - Fetching technician roles...")
            ...
            print("    - Fetching department types...")
            ...
            try:
                ...
                if "error" not in created_site:
                    ...
                    if "error" not in deleted_site:
                        print(f"      ✅ Success - Deleted site")
                    else:
                        print(f"      ❌ Delete error: {deleted_site['error']}")
                        
                else:
                    print(f"      ❌ Create site error: {created_site['error']}")
            except Exception as e:
                print(f"      ⚠️ Skipping CRUD site test: {e}")
            ...
            try:
                ...
                if "error" not in created_group:
                    ...
                    if "error" not in updated_group:
                        print(f"      ✅ Success - Updated user group")
                    else:
                    ...
                    if "error" not in deleted_group:
                        print(f"      ✅ Success - Deleted user group")
                    else:
                        print(f"      ❌ Delete error: {deleted_group['error']}")
                        
                else:
                    print(f"      ❌ Create user group error: {created_group['error']}")
            except Exception as e:
                print(f"      ⚠️ Skipping CRUD user group test: {e}")
            ...
            try:
                ...
                if "error" not in created_dept:
                    ...
                    if "error" not in updated_dept:
                        print(f"      ✅ Success - Updated department")
                    else:
                    ...
                    if "error" not in deleted_dept:
                        print(f"      ✅ Success - Deleted department")
                    else:
                        print(f"      ❌ Delete error: {deleted_dept['error']}")
                        
                else:
                    print(f"      ❌ Create department error: {created_dept['error']}")
            except Exception as e:
                print(f"      ⚠️ Skipping CRUD department test: {e}")
            ...
            try:
                ...
                if "error" not in created_location:
                    ...
                    if "error" not in updated_location:
                        print(f"      ✅ Success - Updated location")
                    else:
                    ...
                    if "error" not in deleted_location:
                        print(f"      ✅ Success - Deleted location")
                    else:
                        print(f"      ❌ Delete error: {deleted_location['error']}")
                        
                else:
                    print(f"      ❌ Create location error: {created_location['error']}")
            except Exception as e:
                print(f"      ⚠️ Skipping CRUD location test: {e}")
...
async def main():
    """Main test function"""
    print("🚀 Starting connection test for ServiceDesk Plus MCP Server v2.0")
    print("=" * 70)
